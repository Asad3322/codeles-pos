...
if (!cashierPassword) {
  throw new Error("SEED_CASHIER_PASSWORD must be set before running the seed script.");
}
  ...
  await Settings.create({
    storeName: "Codeles POS Demo Store",
  ...
  console.log(`   Cashier: cashier@pos.local / [password from SEED_CASHIER_PASSWORD]`);
